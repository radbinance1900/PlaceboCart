  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <Link href="/dashboard" className="inline-flex items-center gap-2 text-[#1A4454] font-black uppercase mb-8 hover:opacity-70">
          <ArrowLeft className="w-5 h-5" />
          Back to Dashboard
        </Link>

        <h1 className="text-4xl font-black uppercase text-[#1A4454] mb-2">{categoryName}</h1>
        <p className="text-gray-600 font-semibold mb-8">
          {products.length} premium products available in this category
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-12">
        {products.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <h2 className="text-2xl font-black text-[#1A4454] mb-2">No products found</h2>
            <p className="text-gray-600 mb-6">This category is currently empty</p>
